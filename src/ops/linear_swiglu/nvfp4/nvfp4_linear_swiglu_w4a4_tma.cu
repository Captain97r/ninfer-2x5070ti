...
void launch_impl(const std::uint8_t* activation_codes, const std::uint8_t* activation_scales,
    ...
    ensure_func_attr_per_device(nvfp4_linear_swiglu_w4a4_tma_kernel<Geometry, M256N128S3>,
...
void launch_nvfp4_linear_swiglu_w4a4_tma(const std::uint8_t* activation_codes,
    ...
    launch_impl<Nvfp4MlpGateUpGeometry>(activation_codes, activation_scales, weight_codes,
...
void launch_nvfp4_linear_swiglu_w4a4_tma_shard(const std::uint8_t* activation_codes,
    ...
    launch_impl<Nvfp4MlpGateUpTp2ColumnGeometry>(activation_codes, activation_scales, weight_codes,
                                                 weight_scales, output, tokens, alpha, stream);
}
