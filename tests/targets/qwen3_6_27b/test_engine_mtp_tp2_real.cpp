...
ninfer::RequestOptions greedy_options(std::uint32_t tokens) {
    ...
    // Keep both comparison sides on cold prefill. Prefix restoration has its own focused
    // cached-versus-cold, two-rank regression in test_engine_prefix_tp2_real.cpp.
